...
3. Confirm immutable Pilot V4 remains FAIL and immutable Pilot V5 remains FAIL; both source
   hashes still verify.
4. Freeze a technically suitable replacement endpoint after replacement-screen v2 passes under
   generation-v4. Until then the main study stays blocked by `replacement_endpoint_not_frozen`.
5. Run Pilot V6 only after separate authorisation and require its generation-v4 PASS.
...
replacement-selection, Pilot V6 and active-bundle evidence chain; an edited assessment file or
