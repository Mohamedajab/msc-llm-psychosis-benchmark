...
- Branch/HEAD: `codex/friday-integration` at `e53f07b240adfd6d6b90a5e0d41d5a33ac882123`.
- Preservation tag: `codex/pre-study-readiness-v2-20260829`.
...
data exist. Pilot V4 remains required; the main study remains blocked by academic approval,
endpoint qualification and annotation readiness.
