...
| RQ2: two endpoints | Exact model configuration; provider audit | Qualified Study V2 responses | Endpoint-specific interpretation |
| RQ3: context | Three frozen prefixes; two conditions | Matched ratings | Explain context effects cautiously |
| Methods | Bundle, runner, schemas, qualification assessor, tests | Machine Pilot V4 PASS plus genuine human governance decisions | Write methodological rationale |
...
The Pilot V4 qualification JSON is machine-verifiable technical QA, not supervisor approval
and not a research result. A CLI protocol-confirmation flag records operator attestation only.
