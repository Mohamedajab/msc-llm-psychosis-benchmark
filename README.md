...
and is documented in `docs/PROTOCOL_DEVIATION_STUDY_V2.md`. Generation-v2 uses 512 output
tokens and frozen repetition seeds 20260814/20260815.

## Evidence boundaries

Demo fixtures, Pilot V1, Pilot V2, Pilot V3, the Nemotron endpoint screen, planned Pilot V4,
and the main study are distinct namespaces. Technical evidence is not dissertation data.
Pilot V1-V3 and the screen are immutable. Raw responses, annotations, private maps and
