...
1. Preserve immutable technical evidence and verify Study V2's frozen bundle.
2. Obtain supervisor/research-group decisions on the revised protocol and draft rubric.
3. Run one separately authorised Pilot V4 qualification; do not treat it as research data.
4. Run the versioned assessor; require its independently recomputed machine verdict to be
   PASS, then review Pilot V4 aggregates by model/context, provider, errors and finish reason.
5. If authorised, collect the 72 manifest rows in small bounded batches with safe resume.
